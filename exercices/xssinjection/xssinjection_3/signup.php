              ...
              <div class="d-flex align-items-center">
                ...
                <div class="col">
                  <div class="bg-white p-3 border border-secondary rounded">
                    <form method="POST" action="<?php echo htmlspecialchars("signup.php?lang=" . $lang, ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401); ?>">
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="firstname" class="form-label fw-bold text-dark"><?php echo isset($lang) && $lang === "fr" ? "Prénom :" : "Firstname:"; ?></label>
                        <input type="text" class="form-control" id="firstname" name="firstname">
                      </div>
                      <div class="mb-3">
                        <label for="lastname" class="form-label fw-bold text-dark"><?php echo isset($lang) && $lang === "fr" ? "Nom :" : "Lastname:"; ?></label>
                      ...
                      <div class="mb-3">
                        <label for="confirmed_password" class="form-label fw-bold text-dark"><?php echo isset($lang) && $lang === "fr" ? "Confirmation mot de passe :" : "Confirmed password:"; ?></label>
                        <input type="password" class="form-control" id="confirmed_password" name="confirmed_password">
                      </div>
                      <div class="d-grid">
                        <button type="submit" name="signup" class="btn btn-dark text-light"><?php echo isset($lang) && $lang === "fr" ? "S'inscrire" : "Sign Up"; ?></button>
                      </div>
                    </form>
                  </div>
                  <div class="error-div">
