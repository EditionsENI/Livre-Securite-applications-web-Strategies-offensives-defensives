<nav class="navbar navbar-expand-lg border-bottom border-2 shadow-lg p-0" id="exercice-header">
  ...
  ?>
      ...
      <div class="collapse navbar-collapse pe-3 justify-content-end">
        <a class="text-light fw-bold ms-2 me-2 ps-1 pe-1 text-decoration-none" href="<?php echo htmlspecialchars('./profile.php?phoneNumber=' . $_SESSION['phoneNumber'], ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401); ?>"><?php echo htmlspecialchars(ucfirst($_SESSION['username']), ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401); ?></a>
