<nav class="navbar navbar-expand-lg border-bottom border-2 shadow-lg p-0" id="exercice-header">
  ...
  ?>
      <div class="ps-3">
        ...
        ?>
            <a class="text-light fw-bold text-decoration-none ps-2" href="monitoring.php">Monitoring</a>
        <?php
          }
        ?>
      </div>
      <div class="collapse navbar-collapse pe-3 justify-content-end">
      <a class="text-light fw-bold ms-2 me-2 ps-1 pe-1 text-decoration-none" href="<?php echo htmlspecialchars('./profile.php?id=' . $_SESSION['id'], ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401); ?>"><?php echo htmlspecialchars(ucfirst($_SESSION['userObj']->username), ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401); ?></a>
