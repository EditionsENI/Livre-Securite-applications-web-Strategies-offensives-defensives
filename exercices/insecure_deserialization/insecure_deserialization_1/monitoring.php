              ...
              <div class="d-flex align-items-center">
                ...
                <div class="col">
                  <div class="bg-white p-3 border border-secondary rounded">
                    ...
                    <?php 
                      echo '<span class="fw-bold">Espace disque disponible :</span> ' . disk_free_space("/") . ' octets';
                      echo '<br />';
                      echo '<span class="fw-bold">Utilisation actuelle de la mémoire :</span> ' . memory_get_usage() . ' octets';
                    ?>
                  </div>
                  <div class="error-div">
                    <?php
