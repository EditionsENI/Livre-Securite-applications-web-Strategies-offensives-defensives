  ...
  if(isset($_POST['username']) || isset($_POST['password'])) {
    if(isset($_POST['username']) && !empty($_POST['username']) && isset($_POST['password']) && !empty($_POST['password'])) {
      try {
        ...
        $stmt = $cnx->prepare("SELECT id, username, firstname, lastname, role FROM users WHERE username = ? AND password = ?");
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="col">
                  <div class="bg-white p-3 border border-secondary rounded">
                    ...
                    <p>
                      Découvrez les nombreuses publications à disposition à tous et gratuitement sur notre plateforme : <a href="./public/">Dossier de partage</a>
                    </p>
                  </div>
                  <div class="error-div">
                    <?php
